    ...
    <div className="rounded-[16px] bg-[#FFFFFF] flex flex-col box-sizing-border">
      ...
      <div className="m-[0_57px_6px_57px] flex flex-row self-start w-[fit-content] box-sizing-border">
        ...
        <div className="bg-[#FFFFFF] p-[13px_16px_12px_16px] w-[228px] box-sizing-border">
          <span className="break-words font-['Roboto'] font-bold text-[16px] text-[#000000]">
          Viết test checklist 
          </span>
        </div>
      </div>
      <div className="m-[0_57px_7px_57px] flex flex-row self-start w-[fit-content] box-sizing-border">
        ...
        <div className="rounded-[5px] bg-[#FFFFFF] flex flex-row justify-between p-[14px_16.2px_14px_16px] w-[221px] box-sizing-border">
          <span className="m-[0_8px_0_0] w-[172.8px] break-words font-['Roboto'] font-normal text-[16px] tracking-[-0.4px] leading-[1] text-[var(--xm-11,#363636)]">
          Family
          </span>
      ...
      <div className="m-[0_57px_12px_57px] flex flex-row self-start w-[fit-content] box-sizing-border">
        ...
        <div className="rounded-[8px] bg-[#FFFFFF] flex flex-row justify-between p-[10px_16px_10px_16px] w-[221px] box-sizing-border">
          <div className="m-[4px_8px_4px_0] inline-block w-[156px] break-words font-['Roboto'] font-normal text-[16px] leading-[1] text-[#000000]">
          December 18 - 24th
          </div>
      ...
      <div className="m-[0_57px_18px_57px] flex flex-row justify-between self-start w-[316.3px] box-sizing-border">
        ...
        <div className="rounded-[8px] bg-[#FFFFFF] flex flex-row justify-between p-[11px_17px_11px_17px] w-[221.3px] box-sizing-border">
      ...
      <div className="rounded-[8px] border-[1px_solid_rgba(0,0,0,0.1)] bg-[#FFFFFF] relative m-[0_57px_116px_57px] self-start p-[18px_18px_36px_18px] w-[fit-content] box-sizing-border">
        <div className="flex box-sizing-border">
          <span className="break-words font-['Roboto'] font-normal text-[16px] text-[#000000]">
          Thiết kế diagram <br />
          Thiết kế map của phường Quán Thánh<br />
          Tạo data
          </span>
        </div>
      </div>
