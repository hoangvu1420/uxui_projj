export default function PopUpVerifycationCode1() {
  return (
    <div className="rounded-[16px] bg-[#FFFFFF] flex flex-col p-[23px_26px_24px_24px] box-sizing-border">
      ...
      <div className="m-[0_3.1px_9px_0] inline-block break-words font-['Inter'] font-[var(--body-1-medium-font-weight,500)] text-[15px] tracking-[var(--body-1-medium-letter-spacing,-0.2px)] leading-[var(--body-1-medium-line-height,1.6)] text-[var(--neutral-041,#6F767E)]">
      We sent verification code to your email. Please check your inbox and enter the code below to sign in.
      </div>
