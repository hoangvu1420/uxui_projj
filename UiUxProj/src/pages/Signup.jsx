  ...
  return (
    <div className="bg-[#FFFFFF] flex p-[78px_117px_0_90px] w-[1440px] box-sizing-border">
      <div className="relative flex flex-row box-sizing-border">
        <div className="m-[0_571.9px_612.4px_0] flex flex-row box-sizing-border">
        ...
        <div className="m-[103px_0_0_0] flex flex-col items-center box-sizing-border">
          <div className="m-[0_0.6px_32px_0] inline-block break-words font-['Inter'] font-[var(--h-2-font-weight,600)] text-[48px] tracking-[var(--h-2-letter-spacing,-1.4px)] leading-[var(--h-2-line-height,1)] text-[var(--neutral-07,#1A1D1F)]">
          Sign up
          </div>
          <div className="m-[0_0_32px_0] flex flex-col items-center w-[fit-content] box-sizing-border">
            ...
            <div className="flex flex-col w-[fit-content] box-sizing-border">
              ...
              <div className="flex w-[360px] box-sizing-border">
                <div className="rounded-[12px] bg-[var(--neutral-02,#F4F4F4)] flex flex-row p-[12px_0_12px_12px] w-[360px] box-sizing-border">
                  <img className="m-[0_12px_0_0] w-[24px] h-[24px]" />
                  <div className="flex box-sizing-border">
                    <span className="break-words font-['Inter'] font-[var(--base-1-semibold-font-weight,600)] text-[15px] tracking-[var(--base-1-semibold-letter-spacing,-0.2px)] leading-[var(--base-1-semibold-line-height,1.6)] text-[#858585]">
          ...
          <div className="m-[0_0_42px_0] flex flex-col items-center w-[fit-content] box-sizing-border">
            <div className="m-[0_0_22px_0] flex w-[360px] box-sizing-border">
              <div className="rounded-[12px] bg-[#6C5DD3] flex p-[12px_0.9px_12px_0] w-[360px] h-[fit-content] box-sizing-border">
          ...
          <p className="m-[0_0.6px_0_0] break-words font-['Inter'] font-[var(--body-2-semibold-font-weight,600)] text-[14px] tracking-[var(--body-2-semibold-letter-spacing,-0.1px)] leading-[var(--body-2-semibold-line-height,1.429)] text-[var(--neutral-04,#6F767E)]">
          <span className="dont-have-an-account-sign-in-sub-3"></span><span></span>
          </p>
        </div>
      </div>
