export default function StateOpen() {
  return (
    <div className="rounded-[8px] flex flex-col box-sizing-border">
      ...
      <div className="rounded-[8px] border-[1px_solid_var(--stroke,rgba(0,0,0,0.1))] bg-[var(--white-3,#FFFFFF)] flex flex-col p-[7px_0_15px_0] w-[100%] box-sizing-border">
        <div className="border-l-[4px_solid_#6C5DD3] m-[0_0_12px_0] p-[8px_12px_8px_12px] w-[100%] box-sizing-border">
          <span className="break-words font-['Roboto'] font-normal text-[16px] leading-[1.25] text-[var(--black-1,#000000)]">
          Select all
          </span>
        </div>
        <div className="m-[0_15px_20px_15px] flex self-start box-sizing-border">
          <span className="break-words font-['Roboto'] font-normal text-[16px] leading-[1.25] text-[var(--black-1,#000000)]">
          Events
          </span>
        </div>
