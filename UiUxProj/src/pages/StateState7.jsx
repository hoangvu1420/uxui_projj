export default function StateState7() {
  return (
    <div className="rounded-[8px] flex flex-col box-sizing-border">
      ...
      <div className="rounded-[8px] border-[1px_solid_var(--stroke,rgba(0,0,0,0.1))] bg-[var(--white-3,#FFFFFF)] flex flex-col p-[15px_0_7px_0] w-[100%] box-sizing-border">
        ...
        <div className="border-l-[4px_solid_#6C5DD3] p-[8px_12px_8px_12px] w-[100%] box-sizing-border">
          <span className="break-words font-['Fira_Sans'] font-normal text-[16px] leading-[1.25] text-[var(--black-1,#000000)]">
          Tasks
          </span>
        </div>
